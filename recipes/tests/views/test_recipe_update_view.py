...
class RecipeUpdateViewTest(TestCase):
    def setUp(self):
        self.author = User.objects.create_user(
            username='@author', password='Password123', first_name='Auth', last_name='Or', email='author@example.com'
        )
        self.other = User.objects.create_user(
            username='@intruder', password='Password123', first_name='Other', last_name='User', email='other@example.com'
        )
