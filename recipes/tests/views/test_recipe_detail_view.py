...
from recipes.models import Recipe, User, Comment, Like, SavedRecipe, Follow
...
class RecipeDetailViewTest(TestCase):
    ...
    def test_recipe_detail_shows_edit_button_for_author(self):
        ...
        self.assertContains(response, reverse('recipe_edit', kwargs={'pk': self.recipe.pk}))
    ...
    def test_recipe_detail_shows_delete_button_for_author(self):
        ...
        self.assertContains(response, reverse('recipe_delete', kwargs={'pk': self.recipe.pk}))
